...
public class NetworkDelayTimeTest {
    ...
    NetworkDelayTime algo = new NetworkDelayTime();
    ...
    public void test_my_1() {
        ...
        int K = 1;
        int output = algo.networkDelayTime(input, N, K);
